...
<The step article — phenomenon before term, gloss first use, in the subject's language. The `## Lesson` body must run at least 3,000 字 (character-script subjects count characters; English ≈ 3,000 words), measured on the body only, headings and sources excluded.>
