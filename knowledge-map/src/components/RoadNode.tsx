...
export function RoadNode({ data, selected }: NodeProps<RoadNodeType>) {
  ...
  return (
    ...
    >
      {/* Check badge when the checklist is complete */}
      {isComplete && (
        <span
      ...
      {/* Label */}
      <div
        className="flex flex-1 items-center justify-center px-2 text-center font-sans text-[0.7rem] font-medium leading-tight"
        style={{ color: "#f5f5f5" }}
      >
        {label}
      </div>
